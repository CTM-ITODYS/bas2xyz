...
character*128 :: outputxyz, inputbas
logical :: stay
!==========================================================================!
...
call getarg(1,inputbas)
inputbas=trim(inputbas)
open(10,file=inputbas,status='old',action='read')
read(10,*) nbatom
allocate(charatom(nbatom),coord(nbatom,3),numat(nbatom))
do i = 1, nbatom
   read(10,*) numat(i),(coord(i,j),j=1,3)
enddo
 close(10)
!==========================================================================!
...
!==========================================================================!
call getarg(2,outputxyz)
outputxyz=trim(outputxyz)

open(55,file=outputxyz,action='write')
write(55,'(9x,i3)') nbatom
write(55,*) 
do i = 1,nbatom
   write(55,'(1x,a3,4x,f10.6,4x,f10.6,4x,f10.6)') charatom(i),coord(i,1),coord(i,2),coord(i,3)
enddo
 close(55)
